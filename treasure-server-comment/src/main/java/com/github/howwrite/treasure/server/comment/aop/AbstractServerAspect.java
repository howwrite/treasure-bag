package com.github.howwrite.treasure.server.comment.aop;
...
import com.github.howwrite.treasure.api.comment.request.AbstractRequest;
import com.github.howwrite.treasure.api.comment.response.Response;
import com.github.howwrite.treasure.comment.util.SplitterUtils;
import com.github.howwrite.treasure.server.comment.exception.ServerException;
...
public abstract class AbstractServerAspect {
    ...
    protected Response<?> doApi(ProceedingJoinPoint joinPoint) {
        ...
        try {
            ...
            final String message = messageSource.getMessage(CommentErrorMap.SYSTEM_ERROR, null, Locale.getDefault());
            return Response.fail(message, CommentErrorMap.SYSTEM_ERROR);
        }
    }
